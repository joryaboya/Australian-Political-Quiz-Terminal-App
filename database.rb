module Database
    ...
    class Database
        ...
        def stats_menu
            users = @@instances
            puts "Welcome to the stats menu. Who's stats would you like to see?"
        ...
        def question1_env_cap 
            puts "1. The free market is more important than sustaining the environment
            "
        ...
        def question1_aut_hum
            puts "2. Punishing the unlawful is more important than supporting the citizens
            "
            input = input_check_int
            input_aut = input - 3
            input_hum = -input_aut
        ...
        def question1_aut_cap
            puts "3. Leniance on criminals is a valid sacrifice for the growth of the economy
            "
            input = input_check_int
            input_aut = input - 3 
            input_cap = -input_aut
        ...
        def question1_env_hum
            puts "4. Neglecting the environmental impact of programs is justified if it improves the lives of the people
            "
            input = input_check_int
            input_hum = input - 3
            input_env = -input_hum
        ...
        def question2_env1
            puts "5. The goverment should allow sale of agriland to foreign buyers at the expence of the enviroment.
            "
            input = input_check_int
            input_env = -(input - 3)
        end
        def question2_cap1
            puts "6. Sunday pay should stay at double wages.
            "
            input = input_check_int
            input_cap = -(input - 3)
        end
        def question2_hum1
            puts "7. The government should increase foreign aid
            "
            input = input_check_int
            input_hum = input - 3
        end
        def question2_aut1
            puts "8. Citizens should lose their citizenship if they join a terrorist group
            "
            input = input_check_int
            input_aut = input - 3
        end
        def question2_env2
            puts "9. Disposible, non-biodegradable products should be banned.
            "
            input = input_check_int
            input_env = input - 3
        end
        def question2_cap2
            puts "10. Tax rates for all buisnesses should be lowered.
            "
            input = input_check_int
            input_cap = input - 3
        end
        def question2_hum2
            puts "11. There should be less restrictions on welfare benifits.
            "
            input = input_check_int
            input_hum = input - 3
        end
        def question2_aut2
            puts "12. The government should regulate social media.
            "
            input = input_check_int
            input_aut = input - 3
        end
        ...
        def question3_env1
            puts "13. Abortion should be legal
            "
            input = input_check_int
            input_abo = input - 3
            @abortion += input_abo
        ...
        def question3_env2
            puts "14. Government should require children to be vaccinated for preventable diseases
            "
            input = input_check_int
            input_vac = input - 3 
            @vaccines += input_vac
        ...
        def question3_cap1
            puts "15. Parental leave payments should be based on the parents wage
            "
            input = input_check_int
            input_par = input - 3 
        ...
        def question3_cap2
            puts "16. The government should fund the Safe Schools Coalition
            "
            input = input_check_int
            input_ssc = input - 3
            @ssc += input_ssc
        ...
        def question3_hum1
            puts "17. Same sex marriage should be legal
            "
            input = input_check_int
        ...
        def question3_hum2
            puts "18. Euthanasia should be legal
            "
            input = input_check_int
            input_euth = input - 3
        ...
        def question3_aut1
            puts "19. The death penalty should be legal
            "
            input = input_check_int
            input_death = input - 3
        ...
        def question3_aut2
            puts "20. Drug testing should be legal at festivals
            "
            input = input_check_int
            input_drugs = input - 3
        ...
        def question4_env
            puts "21. Nuclear energy should be further implemented in Australia
            "
            input = input_check_int
        ...
        def question4_cap
            puts "22. Businesses should be required to have women on board of directors
            "
            input = input_check_int
            input_quota = input - 3
        ...
        def question4_hum
            puts "23. Australia should accept immigrants from asylum seeking boats
            "
            input = input_check_int
        ...
        def question4_aut
            puts "24. Australia should end the monarchy and become a republic 
            "
            input = input_check_int
        ...
        def final_comparison_meth(hash)
